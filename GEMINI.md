...
- `web-designer`: Semantic HTML, responsive CSS, JavaScript UI interactions, maquetacion, visual polish, accessibility, and static frontend layout work.

## Agent Mode Instructions
@./.gemini/agents/sre-engineer.md

@./.gemini/agents/web-designer.md
